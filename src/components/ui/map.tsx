...
// Inline raster tile styles — more reliable than vector GL styles since they
// don't require WebGL font/sprite fetches or a vector tile server.
const osmRasterStyle = (tileUrl: string, attribution: string): MapLibreGL.StyleSpecification => ({
  version: 8,
  sources: {
    "raster-tiles": {
      type: "raster",
...
const defaultStyles: { dark: MapLibreGL.StyleSpecification; light: MapLibreGL.StyleSpecification } = {
  // Carto Positron — visual limpo, fundo claro, tipografia minimalista
  ...
  // Carto Dark Matter — visual escuro elegante
  dark: osmRasterStyle(
